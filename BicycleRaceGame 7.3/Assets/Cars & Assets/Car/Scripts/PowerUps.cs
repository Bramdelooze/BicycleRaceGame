...
public class PowerUps : MonoBehaviour {
    ...
    private ArduinoConnectorScriptCar arduino;

	// Use this for initialization
	void Start () {
        car = FindObjectOfType<CarController>();
        arduino = FindObjectOfType<ArduinoConnectorScriptCar>();
	...
	void Update () {
        ...
        {       
            if (Input.GetKeyDown(KeyCode.P) || (Input.GetKeyDown(KeyCode.Joystick1Button0)))
            {
        ...
        if (wallPowerUp && !powerUpActivated && Input.GetKeyDown(KeyCode.P) || wallPowerUp && !powerUpActivated && (Input.GetKeyDown(KeyCode.Joystick1Button0)))
        {
